...
public class OwnerController {
    ...
    @InitBinder
    public void setAllAlowedFields(WebDataBinder dataBinder){
        dataBinder.setDisallowedFields("id");
    }
    
    @RequestMapping({"", "/list", "/ownersLists.html"})
    public String listOwners(Model model){

        model.addAttribute("owners", ownerService.findAll());
        return "owners/ownersList"; // thymeleaf will look for index file
    }
